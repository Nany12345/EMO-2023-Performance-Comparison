classdef RE42 < PROBLEM
% <multi/many> <real> <large/none> <expensive/none>
% the conceptual marine design.
    ...
    methods
        ...
        function PopObj = CalObj(obj,PopDec)
            ...
            for i = 1:size(PopDec,1)           
                ...
                PopObj(i,1) = annual_costs / annual_cargo;
                PopObj(i,2) = light_ship_weight;
                PopObj(i,3) = -annual_cargo;  % f_2 is dealt as a minimization problem
                ...
                PopObj(i,4) = constraintFuncs(1) + constraintFuncs(2) + constraintFuncs(3) + constraintFuncs(4) + constraintFuncs(5) + constraintFuncs(6) + constraintFuncs(7) + constraintFuncs(8) + constraintFuncs(9);
            end
        end
        %% Sample reference points on Pareto front
        function R = GetOptimum(obj,N)
            R = load('reference_points_RE42.dat');
        end
    end
end