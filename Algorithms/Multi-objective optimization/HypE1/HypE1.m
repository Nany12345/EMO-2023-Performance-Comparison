...
%--------------------------------------------------------------------------
    ...
    methods
        function main(Algorithm,Problem)
            ...
            RefPoint = zeros(1,Problem.M) + max(Population.objs)+1;
...
%                 RefPoint = max([Population.objs;Offspring.objs])*1.1;
                Population = EnvironmentalSelection1([Population,Offspring],Problem.N,RefPoint,nSample);
            end
        end
    end
end